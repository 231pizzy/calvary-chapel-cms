...
export default function AddNewScheduleView({ submitEndpoint, returnUrl }) {
    ...
    const [validationSchema, setValidationSchema] = useState({
        ...
        liveLink: Yup.string().matches(urlRegex, 'Please enter a valid url'),
        // date: Yup.string().required('Please set the date of this schedule'),
                        ...
                        return (<Form style={{ width: '100%', marginBottom: '36px' }}>
                            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                                ...
                                <Box sx={{ mb: 2, width: '100%' }}>
                                    ...
                                    {/* Textfield */}
                                    <FormTextField placeholder={'Type the link for live broadcast of this meeting'} name='liveLink' />
                                </Box>
                                ...
                                <Box sx={{ width: '100%', mt: 2 }}>
                                    ...
                                    {<Box sx={{ mb: 2, width: '100%', position: 'relative' }}>
                                        ...
                                        />
                                        {id && <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 111 }}></div>}
                                    </Box>}
