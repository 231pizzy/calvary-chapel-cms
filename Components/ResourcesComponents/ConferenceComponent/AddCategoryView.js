...
export default function AddCategoryView({ closeForm, sectionName, sectionId, itemName, submitEndpoint, returnUrl, pageName }) {
    ...
    const handleFormSubmit = async (value) => {
        const body = {
            ...value, pageName, update: itemName,
        }
        ...
        await postRequestHandler2({
            ...
            successCallback: body => {
                ...
                if (result) {
                    ...
                    message = 'Conference Category Saved'
