...
export default function AddMinistryView({ closeForm, submitEndpoint, id, name, returnUrl, pageName }) {
        ...
        await postRequestHandler2({
            ...
            successCallback: body => {
                ...
                if (result) {
                    ...
                    message = 'Ministry Resource Created'
                ...
                <Form style={{ width: '100%', marginBottom: '36px' }}>
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                        ...
                        <Box sx={{ mb: 2, width: '100%' }}>
                            {/* Textfield */}
                            <FormTextField placeholder={'Ministry name'} name='sectionTitle' />
                        </Box>
